...
<!--header-->
	<div class="container">
		...
		<div class="contact" >
				...
				<div>
					<span class="me-at"> Old Phone Number</span>
					<input type="text" name="oldPhone">
				</div>
				<div>
					<span class="me-at"> Old Password</span>
					<input type="password" name="oldPass">
				</div> 		 		
				<div>
					<span class="me-at"> Name*</span><br>
					<input type="text" name="name" value="<%= cus.getCustomerName()%>">
				</div> 	
				<div>
					<span class="me-at" > New Password</span>
					<input type="password" name="password">
				</div> 				
				<div> 	
					<span class="me-at">New Phone Number*</span><br>
					<input type="text" name="phone" value="<%= cus.getCustomerPhone()%>"> 
				</div>
				<div>
					<span class="me-at">Address*</span><br>
					<input type="text" name="address" value="<%= cus.getCustomerAddress()%>"> 
				</div>
				<div> 	
					<span class="me-at">Email*</span><br>
					<input type="text" name="email" value="<%= cus.getCustomerEmail()%>"> 
				</div>
							
					<input type="submit" value="Submit" style="margin-left:535px;"> 
				</form>
				</div>
