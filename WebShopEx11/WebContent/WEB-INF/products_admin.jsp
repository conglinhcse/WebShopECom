		...
		<div class="content">
					...
					<%for(Product p : list){ %>
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="updateProduct?id=<%=p.getId() %>"><img class="img-responsive1" src="<%=p.getPathImg()%>" alt="" >
								<%if(p.getDiscount()>0) {%>
								<div class="five">
									<h6 >-<%= p.getDiscount() %>%</h6>
								</div>
			...
			<div class=" possible-about">
				...
				<li><a class="color10" href="#"></a></li>
					...
					<!-- them vao 1 cai truy xuat data o cho get nhung mat hang duoc ban nhieu nhat  -->
						<div class="news">
